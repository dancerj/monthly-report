...
2006年11月19日に第22回Debian勉強会を実施しました。Sid の使いかたについて、
	    ...
	    岩松さんが、パッケージの作り方を cairo-doc パッケージを例
	    にして紹介していました。わかりやすい説明にみんなパッケージ
	    をがんがん作れるようになったようです。
...
2006年11月18日・19日関西の関西オープンソースの中で
Debian BOFを11月19日午後に開催しました。
岩松さん、山根さん、上川で発表しました。
Debian Project の紹介、 Debian JP の紹介、
そして、Debian etch がどういうものになるのか、という紹介をしました。
会場では Debian ユーザが30人程度参加しました。
knoppix ベースのマルチメディア向けディストリビューションを開発している
のがじゅんさんにお会いできたのが印象的でした。
...
\subsubsection{Debian 勉強会のウェブインタフェースがあまりよろしくないのでは?}
...
\newpage
\dancersection{Bug Squashing Party}{岩松}
\subsection{はじめに}
...
\begin{itemize}
 ...
 \item 活動内容
   \begin{itemize}
   \item xxdiff 修正 \#399764
   \item qemu は問題なし \#399382は close しても問題ない
   \item murasaki \#378318 hppa only
   \item libflash-mozplugin \# 399508 arm/ia64 only
   \item rarpd \#395739
   \item cowdancer \#384132
   \item zoph \#398637
   \item リリースノート追従
   \item po-debconf 更新
   \item rsjog
