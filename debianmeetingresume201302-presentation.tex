...
\begin{frame}{本資料は？}
　東京エリアDebian勉強会ホームページ\url{http://tokyodebian.alioth.debian.org/2013-02.html}にて公開してます。
...
気にすることなく使えるとのことです。他の利点、情報については、\\
...
\begin{center}
\includegraphics[height=0.8\textheight]{image201302/osc-tokyo/rc-bugs.png}
\end{center}
...
\begin{frame}{参考：BSP in Japan!}
 ...
 パッケージのバグをみんなで集まって潰す集まりをBSP(Bug Squash Party
バグ潰しパーティー）というのですが、henrichさん主催で、日本でも開かれました。\\
...
　現在、wheezyのリリースゴールのうち、multiarchについては完了したとのこと。
そのため、ia32-libsパッケージ等は除去されたとのことです。\\
...
をすると指示がいろいろ出て、multiarchな設定とメリットを直接感じることができるでしょう。
\begin{center}
\Large
お試しあれ！
\end{center}
