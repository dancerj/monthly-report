...
\begin{center}
設置されている場所のイメージ\\
\includegraphics[height=0.5\textheight]{image201302/osc-tokyo/sakura-ishikari-bld.jpg}
\includegraphics[height=0.5\textheight]{image201302/osc-tokyo/sakura-ishikari-int.jpg}
\end{center}
\end{frame}
%画像はhenrichさんより提供
%http://henrich-on-debian.blogspot.jp/2013/02/introducing-debian-mirrorsakuranejp.html
...
\begin{center}
\includegraphics[height=0.7\textheight]{image201302/osc-tokyo/rc-bugs.png}\\
