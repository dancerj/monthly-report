...
事前周知が十分でなかったようでハンズオンとしては改善の余地がありましたが、
講義自体はウケもよく楽しんでもらえていたのでは、と思います。
%
急遽ミニセッションとして実施した GPG キーサインパーティも好評でした。
今後もOSC で実施していけるよう、水面下で動きがあるようです\footnote{%
...
また、オープンフォースの方から差し入れとして
Debian の「ぐるぐるクッキー」を貰いました。
\begin{figure}[h]
    \centering
...
が途中でタイムオーバーとなり、中途半端な終わり方になってしまいました。
