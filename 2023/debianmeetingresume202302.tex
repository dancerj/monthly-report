...
\rotatebox{10}{\fontsize{30}{30} {\gt ＤＤＴＰ特集}}\\
...
\subsection{2023 年 1 月度 東京エリア・関西合同Debian勉強会}

2023 年 1 月 21 日 (土) に東京エリア Debian 勉強会と関西 Debian 勉強会の合同で
オンラインによる Debian 勉強会を開催しました。参加者は 9 名でした。

% セミナー
セミナー発表は、林さんによる「Debianパッケージング　アップロード編」、BoF「2023年の目標」を行いました。
...
%-------------------------------------------------------------------------------
%\dancersection{DDTP及びDDTSSの紹介}{dictoss}
%-------------------------------------------------------------------------------
%
%\subsection{はじめに}
