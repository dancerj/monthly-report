...
\rotatebox{10}{\fontsize{30}{30} {\gt 年始目標特集}}\\
...
\subsection{2022 年 12 月度 東京エリア・関西合同Debian勉強会}

2022 年 12 月 17 日 (土) に東京エリア Debian 勉強会と関西 Debian 勉強会の合同で
オンラインによる Debian 勉強会を開催しました。参加者は 6 名でした。

% セミナー
セミナー発表は、BoF「2022年を振り返って」、BoF「bookwormフリーズ直前課題共有及び相談」を行いました。
...
%-------------------------------------------------------------------------------
%\dancersection{Debianパッケージング　アップロード編}{林健太郎(kenhys)}
%-------------------------------------------------------------------------------

%\subsection{はじめに}

%-------------------------------------------------------------------------------
%\dancersection{BoF:2023年の目標}{勉強会参加者一同}
%-------------------------------------------------------------------------------
