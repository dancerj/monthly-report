...
\rotatebox{10}{\fontsize{30}{30} {\gt ＤＤサーベイ特集}}\\
...
\subsection{2023 年 4 月度 東京エリア・関西合同Debian勉強会}

2023 年 4 月 15 日 (土) に東京エリア Debian 勉強会と関西 Debian 勉強会の合同で
オンラインによる Debian 勉強会を開催しました。参加者は 12 名でした。

% セミナー
セミナー発表は、dictoss さんによる「Debian で PHP が動く Web サーバを構築してみる (apache2 / nginx)」、林さんによる「Debianパッケージング Open Build Service編」を行いました。
...
%-------------------------------------------------------------------------------
%\dancersection{レポート "Analysis of the Debian Developer Survey (2022) "を読んでみて}{杉本 典充}
%-------------------------------------------------------------------------------
