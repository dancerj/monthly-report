...
\subtitle{2023 年 2 月度} % 東京第 218 回
...
{\footnotesize
 \input{image202302/prework.tex}
}

%\subsection{問題}
%\input{image202302/quiz.tex}

\section{セミナー1}
\emtext{DDTP及びDDTSSの紹介}

\section{セミナー2}
\emtext{ハンズオン：DDTSSを使ってパッケージ説明文を翻訳してみよう}
...
\begin{frame}{今後のイベントの予定}
  \begin{itemize}
  \item 2023/03/11(土) OSC 2023 Online/Spring（セミナー参加）
    \begin{itemize}
    \item Debian Update
    \item \url{https://event.ospn.jp/osc2023-online-spring/session/791416}
    \end{itemize}
  \item 2023/03/18(土) 定例の勉強会はお休み
  \item 2023/04/01(土) OSC 2023 Tokyo/Spring（展示参加）
    \begin{itemize}
    \item \url{https://event.ospn.jp/osc2023-spring/}
    \end{itemize}
  \item 2023/04/15(土) 東京エリア・関西合同 Debian 勉強会（予定）
  \end{itemize}
