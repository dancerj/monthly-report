...
% (+ (* (- 2011 2005) 12) 11 -1) started from zero
...
%-------------------------------------------------------------------------------
\dancersection{sponsorのおしごと}{hoge}
%-------------------------------------------------------------------------------

\subsection{概要}

Sponsor がするべき内容とそれを便利にするツールについて紹介します。
Sponsor の仕事を楽にするためには何をするべきかも見えてくるかも。

\subsection{パッケージの変更を眺める}
\subsubsection{debdiff}
