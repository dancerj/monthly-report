...
def send_notification(from_address, address, title, mail_body):
    ...
    xmpp.send_message(address, title)

    # sending mail with full body
    mail.send_mail(from_address, address, title, mail_body)
...
def send_notification_to_user_and_owner(user_address, owner_address, owners_email, title, mail_body):
    ...
    send_notification(user_address, user_address, title, mail_body)
