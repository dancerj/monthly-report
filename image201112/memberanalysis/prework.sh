...
# 2011 prework format; unfortunately, some are in EUC-JP, some are in ISO-2022-JP.
for A in image2011??/prework.tex; do echo $A;  nkf -w $A | awk ' { if ($0 ~ /\\begin{prework}{(.*)}/ ) {gsub(/\\begin{prework}{/,""); gsub(/}/,""); print $0}}' ; done 
