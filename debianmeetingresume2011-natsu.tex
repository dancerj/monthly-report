...
響もあります。その場合は\texttt{/etc/modprobe.d/(i915|radeon|nouveau)-kms.conf}の
設定を変更する必要があります。
...
\begin{multicols}{2}
 \input{image2011-natsu/quiz.tex}
\end{multicols}
...
\begin{multicols}{2}
 \begin{description}
  \item[本庄 弘典]
	     ...
	     ほげほげふがふがてすとてすとてすと。
  \item[山田 泰資]
	     Debian Project Member。DDになって自分のソフトをパッケージ化して
	     世界征服するのが野望。これでまた野望に一歩近づいた・・・？
  \item[野島 貴英]
	     いろはにほへどちりぬるをわがよたれぞつねならむ
	     ほげほげふがふがてすとてすとてすと。
  \item[まえだ こうへい] 
	     ...
	     ほげほげふがふがてすとてすとてすと。
  \item[岩松 信洋]
             Debian Project Member。東京エリア Debian 勉強会から輩出され
             た Debian Developer１号。
  \item[山本 浩之]
	     いろはにほへどちりぬるをわがよたれぞつねならむ
	     ほげほげふがふがてすとてすとてすと。
  \item[上川 純一]
	     Debian Project Member、 東京エリア Debian 勉強会創始者。
	     印刷物の完成を眺めるのが結構すき。
  \item[森山 京平]
	     いろはにほへどちりぬるをわがよたれぞつねならむ
	     ほげほげふがふがてすとてすとてすと。
  \item[杉本 典充]
	     北海道、関西、東京といろいろな土地で開催するDebian勉強会に出没する道民。
	     主にDebian GNU/kFreeBSDを使いunstableの醍醐味に浸る日々を過ごしている。
  \item[のがた じゅん]
	     いろはにほへどちりぬるをわがよたれぞつねならむ
	     ほげほげふがふがてすとてすとてすと。
  \item[水野 源]
  ...
  \item[倉敷 悟]
	     いろはにほへどちりぬるをわがよたれぞつねならむ
	     ほげほげふがふがてすとてすとてすと。
  \item[かわだ てつたろう] いろはにほへどちりぬるをわがよたれぞつねならむ
	     ほげほげふがふがてすとてすとてすと。
  \item[木下 達也] いろはにほへどちりぬるをわがよたれぞつねならむ
	     ほげほげふがふがてすとてすとてすと。
  \item[山下 康成] いろはにほへどちりぬるをわがよたれぞつねならむ
	     ほげほげふがふがてすとてすとてすと。
 \end{description}
\end{multicols}
