...
\input{template-kansai/term.tex}
...
\input{template-kansai/release_cycle.tex}
...
\begin{frame}
  \begin{itemize}
  \item gnome で初期設定だとマウスが使えない
  \begin{itemize}
    \item 矢印キーで設定パネルまでがんばる!
  \end{itemize}
...
\input{template-kansai/licenses.tex}
