...
\section{セミナー1}
\emtext{go / debian での機械学習環境構築について}
...
\begin{frame}{今後のイベント}
  \begin{itemize}
  \item 2018/4/21(土) 東京エリアDebian勉強会（予定）
    \begin{itemize}
    \item 場所、セミナー内容は調整中
    \end{itemize}    
  \item 2018/5/19(土) 東京エリアDebian勉強会 (予定)
  \item 2018/6/16(土) 東京エリアDebian勉強会 (予定)
  \item 2018/7/7(土) OSC 2018 Hokkaido 出張（関西と合同） (予定)
  \item 2018/7/21(土)- DebConf 2018 (Hsinchu, Taiwan)
