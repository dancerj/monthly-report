...
\begin{getsureiupdate}{月例 Debian GNU/kFreeBSD}
...
\begin{getsureiupdate}{月例 Debian GNU/HURD}
...
\begin{getsureiupdate}{月例 Nexenta}
今月のNexentaの状況をお伝えします。
...
\begin{getsureiupdate}{月例 Debian GNU/Linux SuperH port}
