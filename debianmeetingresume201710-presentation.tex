...
\section{セミナー1}
\emtext{caffとmail-transport-agent}
...
\begin{frame}{今後のイベント}
  \begin{itemize}
  \item 2017/11/18(土) 東京エリアDebian勉強会
    \begin{itemize}
    \item 午後の開催予定で、会場は横浜で調整中
    \item 同タイミングでDPLが来日するため、招待予定
    \item セミナー内容は調整中
    \end{itemize}
  \item 2017/12/16(土) 東京エリアDebian勉強会 (予定)
    \begin{itemize}
    \item 場所、セミナー内容は調整中
    \end{itemize}
