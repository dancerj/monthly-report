...
\begin{itemize}
 ...
 \item LaTeX 一式: ptex-bin dvipdfmx latex-beamer  okumura-clsfiles
       gs-esp xpdf xpdf-japanese evince texlive-latex-extra
 \item emacs / whizzytex 関連一式: whizzytex advi emacs22 yatex gs-cjk-resource gv
...
ます。/etc/nsswitch.conf の hosts 行にmdnsを参照する設定が追加されている
ことを確認してください。
...
deb http://10.0.2.2:9999/debian/ sid main contrib non-free
# apt-get update
# apt-get install \
