...
\dancersection{関西 Debian 勉強会\newline2009年度各種イベント開催実績と総括}{のがたじゅん・佐々木・倉敷}

\subsection{運営状況}
\subsubsection{運営担当の変更}

今年度途中(7月)より、運営担当がたかやさんからのがた・佐々木・倉敷の三名
体制に交代しています。たかやさんが身辺多忙になってきて身動きがとれない
という理由からです。幸いな事に、以前から分担に向けた試行錯誤は進めてい
ましたので、勉強会の運営自体については大きな混乱もなく継続することがで
きました。
...
また、講師がある程度固定化してしまっている中で、継続して常連さんへの講
師依頼をする他、DMC を取り入れてみたり、参加者自己紹介 (LT 発表可) を常
設するなどしてみました。話題にバリエーションが加わって興味深い反面、年
度後半は OpenStreetMapにトピックを持っていかれてしまった感もあります。
...
また、四国ではじまった OpenForce\footnote{%
\url{http://openforce.project2108.com/}}%
に、のがたさんが参加して、ノウハウの紹介などを行っています。

\subsubsection{扱ったテーマ}

勉強会の内容としては、パッケージ開発自体に加えて、Debian の体制にまつわ
る話(gpg や mentors など)や、周辺ツールの利用(bash や reportbug や gdb
など)をとりあげました。来年度のテーマについては、年末年始にまた相談する
ことになっています。

翻訳関連で、東京での流れに乗って DDTSS のハンズオン実習をしましたが、予
想外に反応がありました。もともと需要があったのか、実習したことで身近に
なったのか、はよくわかりませんが…。
