...
lxc は、IBM が始めたプロジェクトで GPL2 の元、公開されています。
開発の中心は、フランスの IBMer の Daniel Lezcano 氏と Michel Normand 氏
の二人です。

Debian では、Squeeze/Sid から一つ前の最新版\footnote{2009年11月27日現在、
0.6.3。}がパッケージとなっています。
...
ので、最新版である必要がなければ、ソースパッケージを取得しても良いでしょ
う。
...
しれません名、実際に lxc を活用しようと考えているなら使い物にはならない
