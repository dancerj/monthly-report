...
\subsection{運営状況}
\subsubsection{運営担当の変更}
今年度は、身辺多忙になってきて身動きがとれない、ということで、7 月から運
営の主担当をたかやさんからのがたさん、佐々木さん、倉敷の 3 名体制に交代
しています。もともと分担に向けた試行錯誤は進めていたので、勉強会の運営自体
については大きな混乱もなく継続されています。

年度当初は、ライブ中継が若干盛り上がっていたのですが、うまく継続できませ
んでした。機材・環境の問題もありますが、それまで中継の実作業を担っていた
人が運営側にシフトして、余力を回せなくなっているのかも知れません。

また、講師がある程度固定化している中で、継続して常連さんへの講師依頼を
する他、DMC を取り入れてみたり、参加者自己紹介 (LT 発表可) を常設
するなどしています。話題にバリエーションが加わって興味深い反面、年度
後半は OpenStreetMapにトピックを持っていかれてしまった感もあります。

\subsubsection{イベント関連}
例年通り、夏の OSC Kyoto と、秋の KOF に出展しています。KOF では、
矢吹さんに DD になるまでの軌跡をお話してもらうなどしました。できれば
勉強会にも来て欲しいところですが、なかなかご多忙で難しいとのことです。

また、四国ではじまった OpenForce に、のがたさんが参加して、ノウハウ
の紹介などを行っているようです。

\subsubsection{扱ったテーマ}
勉強会の内容としては、パッケージ開発自体に加えて、debian の体制に
まつわる話 (gpg や mentors など) や、周辺ツールの利用 (bash や
reportbug や gdb など) がとりあげられました。来年度のテーマに
ついては、年末年始にまた相談することになります。

翻訳関連で、東京での流れに乗って DDTSS のハンズオン実習をしましたが、
予想外に反応がありました。もともと需要があったのか、実習したことで
身近になったのか、はよくわかりませんが……。
...
Kernel の機能は、kernel 2.6.29 で完全にマージされ、カーネルにパッチを当
...
現状、一人で開発、メンテナンスされていることもあり、今後プロジェクト自体
がどうなるのかは先行き見えないところではありますが、メーリングリストを見
ている限りでは、現在も開発は続いているようです。
