...
では、コンテナイメージを作成してみます。lxc のパッケージに含まれる、
...
What IP address do you wish for this container ? [192.168.xxx.xxx] <-- コンテナの IPアドレス
What is the gateway IP address ? [192.168.xxx.xxy] <-- コンテナから見たデフォルトゲートウェイのアドレス
...
クトリ以下にあります。ツリー表示するとこのようになっています。
