...
% (query-replace-regexp "<.*>" "")
	  ...
	  Charles Plessy さん、後藤さん、上川の23 人でした。
	    ...
	    次に、来月にあるDebian Conferenceの紹介を行いました。
	    pbuilder と superh についてのプレゼンテーションを行うことになっているのですが、
	    リハーサルとして、Debian勉強会にて今回内容を説明しました。
	    ...
	    どが紹介されていました(<a
	    href="http://bugs.debian.org/420101">Bug #420101)。
