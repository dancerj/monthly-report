...
\begin{prework}{ 甲斐正三 }
持参するPCは事情によりSidにできないので、今回はハンズオン無しでお話を伺うことになると思いますがよろしくお願いします。
...
常用環境をwheezyからsidにdist-upgradeしました。あっさりアップグレード完了し、今のところ問題無く使えてます。
...
2.(c)debootstrap + schrootでsidへ切り替えるようにしました。
...
\begin{enumerate}
\item chroot を使ってホーム以下に sid 環境をつくる

\item /home/takuya/chroot/sid 以下に chroot環境な sid を構築
\begin{commandline}
