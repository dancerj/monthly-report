...
\subsection{dh\_auto\_install動作解説1}
...
\subsection{dh\_auto\_install動作解説2}
\begin{itemize}
...
\subsection{dh\_auto\_install動作解説3}
...
\subsection[containsverbatim]{dh\_auto\_install動作解説3}
...
\subsection{DEBHELPERのプログラム共有のオプションその他1}
\begin{table}[htb]
\scalebox{0.6}[0.6]{
\begin{tabular}{|l|p{30em}|} \hline
オプション & 動作 \\ \hline
...
\subsection{DEBHELPERのプログラム共有のオプションその他2}
\begin{table}[htb]
\scalebox{0.6}[0.6]{
\begin{tabular}{|l|p{30em}|} \hline
オプション & 動作 \\ \hline
