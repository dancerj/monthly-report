...
\begin{frame}{今後のイベントの予定}
  \begin{itemize}
  \item 2021/07/22(木) ディストリビューション開発もくもく会 2021 年 7 月
  \item 2021/08/21(土) 東京エリア・関西合同 Debian 勉強会 （予定） \\
    【東京エリアDebian勉強会 第 200 回記念】 \\
    Debian 11 bullseye リリースパーティ Online ？
  \item 2021/08/28(土) ODC（オープンデベロッパーズカンファレンス）オンライン
