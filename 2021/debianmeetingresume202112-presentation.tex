...
\subtitle{2021 年 12 月度} % 東京第 204 回
...
\section{セミナー1}
\emtext{lintianに新規ルールを追加する方法}

\section{セミナー2}
\emtext{Debian で Android アプリ開発と Kotlin}
...
\begin{frame}{今後のイベントの予定}
  ...
  \item 2022/02/19(土) 東京エリア・関西合同 Debian 勉強会 （予定）
  \item 2022/03/11(金)-12(土) OSC 2022 Online/Spring （出展検討中）
  \end{itemize}
