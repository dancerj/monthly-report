...
{\footnotesize
  \input{image202106/prework.tex}
}

%\subsection{問題}
%\input{image202106/quiz.tex}

\section{セミナー1}
\emtext{bullseye のリリースノート日本語版の翻訳レビュー}

\section{セミナー2}
\emtext{bullseyeリリースに対する期待と使いこなし方、相談会}
...
\begin{frame}{今後のイベントの予定}
  \begin{itemize}
  \item 2021/06/27(日) ディストリビューション開発もくもく会2021年6月
  \item 2021/07/17(土) 東京エリア・関西合同Debian勉強会（予定）
