...
\rotatebox{10}{\fontsize{30}{30} {\gt ｓｙｓｔｅｍｄ、ＤＤＴＰ特集}}\\
...
\subsection{2021年3月度 東京エリア・関西合同Debian勉強会}

2021年3月21日(日)に東京エリアDebian勉強会と関西Debian勉強会の合同で
オンラインによるDebian勉強会を開催しました。参加者は15名でした。

セミナーは野首さんによる「Gnukのエミュレーションモードを試してみよう」および参加者全員による「Debian次期安定版"bullseye"フリーズ状況確認及び開発相談」を行いました。
