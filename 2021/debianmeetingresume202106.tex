...
\rotatebox{10}{\fontsize{30}{30} {\gt レビュー＆翻訳}}\\
...
\subsection{2021年5月度 東京エリア・関西合同Debian勉強会}

2021年5月15日(土)に東京エリアDebian勉強会と関西Debian勉強会の合同で
オンラインによるDebian勉強会を開催しました。参加者は9名でした。

セミナーは上川さんによる「DebianにおけるGo」、林さんによる「DebianでReimbursementの制度を利用するには」および参加者全員による「Debian次期安定版"bullseye"のリリースノート翻訳段取り検討」を行いました。

%「DebianにおけるGo」では、。

%「DebianでReimbursementの制度を利用するには」では、

%「Debian次期安定版"bullseye"のリリースノート翻訳段取り検討」では、
