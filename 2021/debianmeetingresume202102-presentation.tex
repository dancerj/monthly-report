...
\section{セミナー1}
\emtext{DebianでWAF ModSecurity-nginx 3.0.4による Web Application Firewall}

\section{セミナー2}
\emtext{webブラウザでメモの同時共有ができる Etherpad の紹介}
...
\begin{frame}{今後のイベントの予定}
  \begin{itemize}
  \item 2021/02/23(火) ディストリビューション開発もくもく会2021年2月
  \item 2021/03/05(金)-06(土)  オープンソースカンファレンス2021 Online/Spring（Debian勉強は出展なし）
  \item 2021/03/？(？) 東京エリアDebian勉強会（調整中）
  \item 2021/04/17(土) 東京エリアDebian勉強会（予定）
  \item 2021/05/15(土) 東京エリアDebian勉強会（予定）
  \end{itemize}
