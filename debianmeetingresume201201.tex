...
Debian 勉強会予約システムの開発から2年経ちました。当初は宴会君をリプレー
...
<html>
  <head>
    ...
    <script src="http://localhost:8080/eventregister?eventid=df24a1e1de11c067c461537dce6394e0e51df6ad&user_prework=&user_attend=attend&user_enkai_attend=enkai_attend&user_realname=myname">
    </script>
  </head>
...
xhr.send('eventid=df24a1e1de11c067c461537dce6394e0e51df6ad&user_prework=%E3%81%BC%E3%81%8F%E3%81%AF%E3%81%BE%E3%81%A1%E3%81%A1%E3%82%83%E3%82%93&user_attend=attend&user_enkai_attend=enkai_attend&user_realname=hamachi');
</script>
\end{commandline}
...
度の脆弱性と、自由にHTMLが記述できる自由とどちらが重要か。すこし悩ましい
と思いませんか?
