...
\subsection{概要}
GNU Ocatave は計算処理のための高級言語で、MATLAB\textregistered()という
数値計算の商用ソフトウェアとの互換性があるようです。行列計算、連立方程式、
微分・積分、グラフ出力などに使えます。グラフ描画のためには、gnuplotが必要です。

一方、GNU Rは統計解析のためのプログラミング言語で、文法的には、S言語や
Schemeに影響を受けているようです。Octaveとは異なり、グラフ描画には
gnuplotは必要ないようです。Excel\textregistered()などのデータ読み込みが
できるといった、データの互換性にも特徴があります。
...
2001/08,34,212,6.24,146.9,4995,35,2.2,0.06,78.9,2760,60,6,0.1,19,1140,,
2001/09,29,156,5.38,127.6,3699,28,2.3,0.08,91.1,2550,,,,,,,
2001/10,30,126,4.2,100.6,3018,31,2.3,0.07,90.6,2810,63,6,0.1,18.1,1140,,
2001/11,32,155,4.84,115.4,3692,29,4.7,0.16,131.4,3810,,,,,,,
2001/12,29,167,5.76,136.9,3971,32,4.3,0.13,114.1,3650,63,7,0.11,19,1200,,
2002/01,34,217,6.38,150.8,5127,29,5.6,0.19,144.1,4180,,,,,,,
2002/02,29,136,4.69,111.9,3246,29,4.8,0.17,133.1,3860,58,6,0.1,19.7,1140,,
2002/03,28,139,4.96,118.4,3315,33,4.9,0.15,118.2,3900,,,,,,,
2002/04,29,127,4.38,101.2,2935,29,4.1,0.14,122.8,3560,62,9,0.15,21.3,1320,,
(snip)
\end{commandline}
...
では、これを Octave, Rではどのようにするのかを見てみましょう。

\subsubsection{Octaveの場合}

octave3.2をインストールしたら、デスクトップ環境のメニューの「開発」→
「GNU Octave」からoctaveのターミナルを起動でき、インタラクティブモードで
実行することができます。が、若干レスポンスにもたつきを感じました。シェル
から\texttt{octave}コマンドを実行しても同じCUIを利用できるので、それで良
いでしょう。
...
6     2001/9   29 156    5.38   127.6 3699     28  2.3    0.08      91.1  2550
7    2001/10   30 126    4.20   100.6 3018     31  2.3    0.07      90.6  2810
8    2001/11   32 155    4.84   115.4 3692     29  4.7    0.16     131.4  3810
9    2001/12   29 167    5.76   136.9 3971     32  4.3    0.13     114.1  3650
10    2002/1   34 217    6.38   150.8 5127     29  5.6    0.19     144.1
 4180
(snip)
...
7       63     6      0.10  18.1  1140        NA    NA
8       NA    NA        NA    NA    NA        NA    NA
9       63     7      0.11  19.0  1200        NA    NA
...
> summary(konetsu)
 ...
 (Other):95
      yen           days.1           m.3           m.3.day
 Min.   : 918   Min.   :11.00   Min.   : 0.00   Min.   :0.0000
 1st Qu.:3858   1st Qu.:29.00   1st Qu.: 4.30   1st Qu.:0.1400
 Median :4598   Median :30.00   Median : 5.80   Median :0.1900
 Mean   :4585   Mean   :30.15   Mean   : 9.08   Mean   :0.3008
 3rd Qu.:5250   3rd Qu.:32.00   3rd Qu.: 9.00   3rd Qu.:0.3175
 Max.   :8252   Max.   :36.00   Max.   :44.00   Max.   :1.5700

   yen.day.1         yen.1          days.2          m.3.1
 Min.   : 49.4   Min.   :1231   Min.   :49.00   Min.   : 3.00
 1st Qu.: 93.3   1st Qu.:2822   1st Qu.:60.00   1st Qu.: 9.00
 Median :123.0   Median :3742   Median :61.00   Median :10.00
 Mean   :127.7   Mean   :3765   Mean   :60.47   Mean   :11.76
 3rd Qu.:146.2   3rd Qu.:4382   3rd Qu.:62.00   3rd Qu.:12.00
 Max.   :543.5   Max.   :8705   Max.   :64.00   Max.   :29.00
                                NA's   :51.00   NA's   :51.00
   m.3.day.1           fee.d           yen.2        yen.day.2
 Min.   : 0.0500   Min.   :15.70   Min.   : 960   Min.   :18.40
 1st Qu.: 0.1550   1st Qu.:22.15   1st Qu.:1320   1st Qu.:19.30
 Median : 0.1800   Median :23.60   Median :1440   Median :20.25
 Mean   : 0.1939   Mean   :30.57   Mean   :1848   Mean   :25.24
 3rd Qu.: 0.1900   3rd Qu.:40.60   3rd Qu.:2480   3rd Qu.:33.50
 Max.   : 0.4700   Max.   :62.90   Max.   :3897   Max.   :43.20
 NA's   :51.0000   NA's   :51.00   NA's   :  51   NA's   :84.00
     yen.3
 Min.   :1176
 1st Qu.:1176
 Median :1176
...
以下は、それぞれ、電気、ガス、水道の使用量を表示した例です。

\begin{commandline}
> konetsu$days
  [1] 11 33 30 28 34 29 30 32 29 34 29 28 29 33 29 29 34 29 32 31 27 35 29 27 30
 [26] 33 28 30 34 29 32 29 29 34 29 28 33 31 28 33 29 33 29 30 31 30 31 27 33 33
 [51] 28 31 29 32 31 31 28 35 28 28 30 34 28 30 32 31 12 28 34 28 34 28 29 28 34
 [76] 29 29 33 31 28 33 29 34 29 28 29 34 28 30 33 30 31 30 28 33 30 28 30 33 28
[101] 33 30
> konetsu$kWh
  [1]  34  95 129 155 212 156 126 155 167 217 136 139 127 163 156 243 363 217
 [19] 184 169 143 214 166 160 182 201 173 204 260 235 198 156 154 216 184 163
 [37] 189 183 176 285 302 315 194 178 188 189 200 186 189 186 152 224 248 251
 [55] 187 167 158 165 218 171 184 219 176 242 281 262  39 170 210 174 234 198
 [73] 209 193 237 196 202 363 250 176 229 210 270 219 203 187 232 187 238 253
 [91] 206 207 197 187 236 219 201 194 218 197 256 298
>
> konetsu$m.3
  [1]  4.9  3.5  3.0  1.7  2.2  2.3  2.3  4.7  4.3  5.6  4.8  4.9  4.1  4.9  4.0
 [16]  4.3  4.3  4.1  6.1  5.8  8.3  6.0  5.8  6.1  4.9  5.9  4.4  4.7  3.3  3.8
 [31]  4.7  5.2  5.5  7.4  5.4  5.6  4.3  3.3  3.3  2.9  3.1  4.1  5.8  6.4  6.9
 [46]  7.0  7.0  7.7  4.5  4.5  3.0  3.0  2.6  3.4  3.5  5.4  4.7 12.5  6.9  6.1
 [61]  4.6  4.5  3.5  3.2  2.6  0.0  6.0  7.0  9.0  9.0  9.0  9.0  9.0  9.0  9.0
 [76]  9.0 10.0  8.0  9.0 11.0 11.0 27.0 44.0 19.0 15.0 15.0 11.0  8.0  7.0  7.0
 [91] 13.0 22.0 27.0 44.0 34.0 43.0 44.0 29.0 21.0 25.0 13.0 15.0
> konetsu$m.3.1
  [1]  9 NA  3 NA  6 NA  6 NA  7 NA  6 NA  9 NA 11 NA 12 NA 11 NA 10 NA  8 NA 10
 [26] NA 12 NA 10 NA  8 NA 10 NA  9 NA  8 NA 11 NA 10 NA 11 NA 12 NA 11 NA 10 NA
 [51] 10 NA 11 NA 10 NA  9 NA 11 NA 10 NA  9 NA  9 NA  8 NA 11 NA 10 NA 12 NA 12
 [76] NA 13 NA 14 NA 14 NA 10 NA 14 NA 11 NA 11 NA 21 NA 29 NA 23 NA 28 NA 25 NA
[101] 25 NA
\end{commandline}

それでは、これを gnuplot と同じようにプロットしてみます。
...
Debian ではGNU RはCRANのパッケージがdebパッケージ化されていると上述しま
