...
57回は10月31日(土)に日本工学院大学の蒲田キャンパス12号館でOSC 2009
Tokyo/Fallでブースのみ出展しました。Squeeze/SidのLiveDVDの配布、SH4の新
しいボードでのDebianの展示、勉強会過去資料の展示、ステッカーの配布・販売
などを行いました。事前のアナウンスを見たヒトとのキーサインも行われていま
した。
また、学生との交流もできたので、Debconf in Japanや出張Debian勉強会・
Debian温泉の企画にも進展がありそうです。

宴会はJR蒲田駅東口の春香園で餃子パーティを行いました。値段の割においしく、
量も多かったので、満足です。新しくDDとなった谷口さんとのキーサインも行わ
れました。
...
% ===============================================================
\dancersection{Octave, GNU R 事始め。}{まえだこうへい}
\index{GNU R}
\index{Octave}
\index{Gnuplot}
% ===============================================================
...
% ===============================================================
\dancersection{Octave, GNU R で行うごりごりプロット}{まえだこうへい}
\index{GNU R}
\index{Octave}
\index{Gnuplot}
% ===============================================================
