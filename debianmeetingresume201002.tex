...
\label{sec:envmach}節でも述べた、環境を渡してゆく方法で
...
こちらで同じ役割を果たすlambda\_tは仮引数リストの代わりにpatternのリストを持っているのと、
Haskellの関数束縛宣言およびパターン束縛宣言におけるwhere節の環境を構築するための関数を保持ためのフィールドが増えています。
