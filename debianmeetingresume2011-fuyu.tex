...
% 発行日付を定義する。毎回変わります。
% 大抵はコミケでの販売日
\newcommand{\debmtgyear}{2011} % 発行年
\newcommand{\debmtgmonth}{12} % 発行月
\newcommand{\debmtgdate}{17} % 発行日
\newcommand{\debmtseasons}{冬} % 夏/冬
% 雑誌タイトル
\newcommand{\journaltitle}{あんどきゅめんてっど でびあん \debmtgyear{}年\debmtseasons{}号}
...
\hfill \debmtgyear{}年\debmtgmonth{}月\debmtgdate{}日 初版発行
