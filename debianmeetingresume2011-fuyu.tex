...
\item パッケージの中身の確認: \texttt{debc ../mypackage<TAB>.changes}
\item 以前のバージョンとの比較: \newline
...
\item ML: \href{mailto:debian-mentors@lists.debian.org}{debian-mentors@lists.debian.org}
