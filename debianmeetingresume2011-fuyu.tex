...
8. C\\ Emdebian Grip はパッケージからドキュメントファイルなどのa 組み込みには必要のないファイルを削除したパッケージを提供するディストリビューション。\\
...
収録範囲は東京エリアは2011年6月勉強会(第X回)から2011年11月勉強会(第X回)、関西エリアは第X回から第X回 まで。
% FIXME: 回数を修正すること。
