...
%\subsection{問題}
%\input{image202011/quiz.tex}

\section{セミナー1}
\emtext{DebianでのPython}

\section{セミナー2}
\emtext{debexpo(mentors.d.n)をハックするには(2020年版)}
...
\begin{frame}{今後のイベントの予定}
  \begin{itemize}
  \item 2020/12/19(土) オープンデベロッパーズカンファレンス2020
  \item 2020/12/20(日) 東京エリアDebian勉強会（予定）
