...
\dancersection{バージョン管理システム Git を使う}{小林儀匡}
\label{sec:vcsgit}
\index{XX@YY} 
...
それでは、インストールしたOSを起動してみましょう。\footnote{インストール
の際に用意したデバイス情報と異なるとCDROMデバイスを探しにいって毎回エラー
を出力してくるので、ダミーで適当なCDROMデバイスを接続してあげています。}

\begin{commandline}
[18:32:01]dancer64:nexenta> qemu-system-x86_64 -hda nexenta.cow \
 -cdrom xxxx \
 -m 512 
\end{commandline}
