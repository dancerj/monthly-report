...
ます\footnote{取得したファイルを \url{image201301/enquete.CV} において
おきます。}
...
気になるので例をみてみましょう。2010年12月の勉強会のDebian Miniconf企画
会議はぐだぐだだったので仕方がないでしょう。一方、
2012年1月の勉強会に辛口の評価が多かったのが気になります。n=4 なのでそん
なに少数派でもないようです。
...
% \begin{figure}[h]
% \begin{center}
%  \includegraphics[angle=270,width=0.8\hsize]{image201301/raw_average_score_growth.eps}
% \caption{毎回のスコアの平均点}
% \end{center}
% \end{figure}
...
% \begin{figure}[h]
% \begin{center}
%  \includegraphics[angle=270,width=0.8\hsize]{image201301/raw_standard_deviation_density.eps}

% \caption{スコアの平均の標準偏差の分布}
% \end{center}
% \end{figure}

% \begin{figure}[h]
% \begin{center}
%  \includegraphics[angle=270,width=0.8\hsize]{image201301/scaled_average_score_density.eps}

% \caption{それぞれの人のスコアが平均０標準偏差１になるように正規化してか
%  ら平均をとったスコア}
% \end{center}
% \end{figure}
