...
%-------------------------------------------------------------------------------
\dancersection{DFSGの求める自由と最近の日本}{上川純一}
%-------------------------------------------------------------------------------

\subsection{はじめに}

DFSGは自由なソフトウェア開発を理想と考えるものです。

しかし自由なソフトウェア開発は自明に支持されるものではありません。
各国においての法律、企業による技術的設計・制約などに影響されます。

ソフトウェア開発の自由がないとソフトウェア利用の幅が失われるだけでなく、
未来のソフトウェアを開発できる層が薄くなることに至ります。

自分で書いたソフトウェアを動かせないハードウェアが出てきたらそれではソフト
ウェアの自由が満たせませんね。

一年の棚卸の意味も兼ねて、最近の事情を調べてみました。

\subsection{著作権法改正}

最近どんな法律が制定されているのか調べて見ました。
大きなものでは２０１２年の改正著作権法でしょう。
