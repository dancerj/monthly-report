...
\subtitle{2022 年 7 月度} % 東京第 211 回
...
{\footnotesize
 \input{image202207/prework.tex}
}

%\subsection{問題}
%\input{image202207/quiz.tex}

\section{セミナー1}
\emtext{DebConf 22 コソボ 現地レポート}
...
\begin{frame}{今後のイベントの予定}
  ...
  \item 2022/08/20(土) 東京エリア・関西合同 Debian勉強会（予定）
    \begin{itemize}
    \item DebConf 22のビデオを見て内容を共有するセミナー（予定）
    \end{itemize}
  \item 2022/09/03(土) Open Developers Conference 2022 Online（予定）
