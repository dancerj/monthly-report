...
\subtitle{2022 年 11 月度} % 東京第 215 回
...
%\subsection{問題}
%\input{image202211/quiz.tex}

\section{セミナー1}
\emtext{Debianパッケージング repack編 ～そのソフトウェア、そのまま配布して大丈夫だっけ～}
...
\begin{frame}{今後のイベントの予定}
  ...
  \item 2023/03/10(金)～3/11(土) OSC 2023 Online/Spring（セミナー参加予定）
