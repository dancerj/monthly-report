...
\subtitle{2022 年 1 月度} % 東京第 205 回
...
{\footnotesize
 \input{image202201/prework.tex}
}

%\subsection{問題}
%\input{image202201/quiz.tex}
...
\begin{frame}{2021年の振り返りと2022年の目標}
\begin{itemize}
...
\begin{frame}{今後のイベントの予定}
  \begin{itemize}
  \item 2022/02/19(土) 東京エリアDebian勉強会（予定）
  \item 2022/03/10(金)-11(土) OSC 2022 Online/Spring（出展するかは未定） 申込締切：2022/1/31(月)
  \item 2022/03/19(土) 東京エリアDebian勉強会（検討中）
  \end{itemize}
