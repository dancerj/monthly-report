...
\rotatebox{10}{\fontsize{30}{30} {\gt パッケージｒｅｐａｃｋ}}\\
...
\subsection{2022 年 10 月度 東京エリア・関西合同Debian勉強会}

2022 年 10 月 15 日 (土) に東京エリア Debian 勉強会と関西 Debian 勉強会の合同で
オンラインによる Debian 勉強会を開催しました。参加者は 9 名でした。

% セミナー
セミナー発表は、dictoss さんの「Debian で KVM を使う (CLIで呼吸している人向け)」、参加者全員のBoF「Debian 12 bookworm フリーズに向けたsidの日本語環境の動作確認状況共有」を行いました。

BoFの議事録は以下です。

\url{https://tokyodebian-team.pages.debian.net/2022-10_tokyodebian_bof.txt}
...
%-------------------------------------------------------------------------------
%\dancersection{titlename}{username}
%-------------------------------------------------------------------------------
