...
\rotatebox{10}{\fontsize{30}{30} {\gt 年末振り返り特集}}\\
...
\subsection{2022 年 11 月度 東京エリア・関西合同Debian勉強会}

2022 年 11 月 19 日 (土) に東京エリア Debian 勉強会と関西 Debian 勉強会の合同で
オンラインによる Debian 勉強会を開催しました。参加者は 8 名でした。

% セミナー
セミナー発表は、林さんの「Debianパッケージング repack編 ～そのソフトウェア、そのまま配布して大丈夫だっけ～」を行いました。
