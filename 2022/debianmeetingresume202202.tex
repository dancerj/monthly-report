...
\rotatebox{10}{\fontsize{30}{30} {\gt コントリビュート＆ｐｙｔｈｏｎ}}\\
...
\subsection{2022 年 1 月度 東京エリア・関西合同Debian勉強会}

2022 年 1 月 15 日 (土) に東京エリア Debian 勉強会と関西 Debian 勉強会の合同で
オンラインによる Debian 勉強会を開催しました。参加者は 9 名でした。

% BoFの話
セミナーは「2021 年の振り返りと 2022 年の目標」について意見を出し合う BoF を行いました。前半は 2021 年の活動の振り返りを行い、後半は 2022 年の各自の目標や興味関心のある技術や知識を共有しました。

BoF で話し合った内容は以下URLに議事録をまとめています。

\url{https://tokyodebian-team.pages.debian.net/2022-01_tokyodebian_bof.txt}
