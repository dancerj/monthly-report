...
\subtitle{2022 年 12 月度} % 東京第 216 回
...
{\footnotesize
 \input{image202212/prework.tex}
}

%\subsection{問題}
%\input{image202212/quiz.tex}

\section{セミナー1}
\emtext{2022年を振り返って}

\section{セミナー2}
\emtext{bookwormフリーズ直前課題共有及び相談}
...
\begin{frame}{今後のイベントの予定}
  \begin{itemize}
  \item 2023/01/21(土) 東京エリア・関西合同 Debian勉強会（予定）
