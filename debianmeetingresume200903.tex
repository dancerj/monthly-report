...
\begin{multicols}{2}
 ...
 \begin{enumerate}
  ...
  \item OSC, パッケージハンズオン（岩松さん）, VAIO P（やまださん）
  \item カーネル＋ディストリビューション (東京大学?)
  \item Git ハンズオン（岩松さん） (荻窪?)
  \item 家Debian vs 職場NW（藤沢さん）(千代田区都立図書館?\footnote{\url{http://www.library.chiyoda.tokyo.jp/}})
  \item Asterisk
  \item スペインにて開催
  \item Debconf報告会
  \item OSC Fall
  ...
  \item Debian サーバ + VMware + 各種OS、忘年会
 \end{enumerate}
...
% ===============================================================
\dancersection{カーネル読書会　ディストリビューション大集合}{上川純一}
\index{kernel}
\index{SVM}
\index{distribution}
\index{ぶんさん@分散}
