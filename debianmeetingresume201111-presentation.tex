...
\emtext{Debian topic update\\3月から何が変わったのか}
...
\item CUT(onstantly Usable Testing) プロジェクト\\
...
%\LARGE{んで、フリーズはいつよ？}\\
\includegraphics[width=1\hsize]{image201111/yaruo-freeze.png}
\end{center}
