...
\item リリースサイクル：おおよそ2年
  ...
  \end{itemize}
\item 標準サポート期間：3年
\item LTS（Long Term Support）：5年
  \begin{itemize}
  \item サポートするアーキテクチャが絞られる
  %\item 全パッケージを維持するわけでなく、主要パッケージに絞られる
...
\begin{itemize}
\item mips アーキテクチャ（32bit ビッグエンディアンのmips）を testing と unstable から削除した
\item 次の Debian 11 では mips アーキテクチャはリリースされない
\item Debian 9 および Debian 10 では mips アーキテクチャのサポートは継続する
\item サポート終了の理由
  \begin{itemize}
...
\begin{itemize}
\item 今後の Init System をどうしていくのがよいか投票をする案内が出た
\item \url{https://www.debian.org/vote/2019/vote_002}
\item 選択肢は3つ
  \begin{itemize}
  \item Affirm Init Diversity
