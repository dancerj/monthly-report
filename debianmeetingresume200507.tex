...
した．その主旨は．
}{匿名で各ユーザにメールを出すのではなく，debian-devel-announceに誰が出
したのかを明確にして出そう}{}{}
\santaku{Andreas Barthはetchに向けてリリースポリシーについてどういう変更が必要だと説
明したか}{}{}{共有ライブラリはダイナミックにリンクすべきであり，ソースコード
をコピーするのは禁止しよう．}

\santaku{etchにむけてc++のABIが変更になるため，Matthias Klose は何を宣言
したか}{}{とりあえず今C++のライブラリであたらしいABIバージョンのものにつ
いてはアップロードしないようにフリーズする}{}
\santaku{Debconfでの講演のスケジューリングについて今回はどういうこころみ
がなされたか}{}{}{参加したい講演の投票をおこない，参加者ができるだけ参加
できるようにスケジューリングをする}
...
{}{
Debianパッケージをカスタマイズしてビルドする手順がかいてある}{}
\santaku{}{}{}{}
...
\santaku{OskuroがGNOMEについて宣言したのは何か}{}{Gnome 2.10がunstableに
入った}{}
...
のみでリンクするようにしてほしい}
\santaku{Bill Allombertがmenuについて報告したのは}{メニューのセクション
は国際化できるようになった}{}{}
\santaku{Javiが}{}{}{}
