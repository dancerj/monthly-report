...
　\item [Step 3.] パッケージが完成したら、mentor.debian.netにアップロードして、mentorを募る。うまくmentorがつけば、Debianのパッケージリリースのプロセスにのるハズ。
   \end{description}
 \item [様子]\mbox{}\\
   MLに流れるやりとりよりも、圧倒的にIRCで交わされるやりとりの方が多く話も早い。またIRCには誰かしら中核の人がいる模様で、親切にいろいろ答えてくれました。
 \end{description}
\newpage
\subsection{所感}
 ...
 \begin{itemize}
   \item Debian Game Teamのエリアに自分のgitリポジトリを掘るときに「こうしていいか？ああしていいか？」といちいち許可を求めると、ウザがられるのは驚いた。（最後はあなたの好きにしてくれ、まずかったら指摘を受けるからその時に覚えてくれといわれてしまった）
   \item Teamの関係者と面識が在るといろいろやりやすいと思う。
　 \item Debian Game Team以外でも近くに相談できるDDがいると大変違う気がする（Debianで常識、Debian Game Teamで常識をうまく切り分けられる）
