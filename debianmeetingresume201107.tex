...
% (+ (* (- 2011 2005) 12) 7 -1) started from zero
\newcommand{\debmtgnumber}{78}
...
% ここはアップデートすること
\rotatebox{10}{\fontsize{32}{32} {\gt 特集 Debconf}}
...
%-------------------------------------------------------------------------------
\dancersection{Debconfでやること}{岩松}
%-------------------------------------------------------------------------------
\index{hoge}

多分、Debconfでやってることのメモとかすればいいんじゃないか。
