...
News on Debian Autobuilding
pam-auth-update: manhandling debconf for fun and profit
Trust is good, control is better
Using FOSSology for license analysis in Debian 
...
\begin{itemize}
 ...
 \item pam-auth-update: manhandling debconf for fun and profit \\
 ...
 \item Changing the default system shell\\
...
\item DDE, Debian Data Export\\
 ...
 \item Libvirt: Hypervisor independent virtual machine management\\
       libvirt という仮想マシンを扱うための API の話です。Debian 固有の話
       は特になく、libvirt の紹介をしていました。Debian でもちゃんと使え
       るようなので、ぜひ使ってみましょう。

 \item RFH maintaining big packages\\
