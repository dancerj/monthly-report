...
\subsection{まとめ}
今回は dh_make からの作成でしたが、cdbs を使うともっと簡単かつ簡潔に作成することができます。
過去の勉強会資料にちょっとだけ載っているので、参考にしてください。
最近はドライバも linus ツリーに取り込まれやすくなったので、早く使いたい人向けの
パッケージになりつつあるドライバパッケージ群ですが、Linuxのリリース感覚とユーザビリティを考えると
重要なパッケージになっていると思います。今後はこれらのパッケージをどのように
メンテナンスしていくかなどについて調べていこうと思います。
