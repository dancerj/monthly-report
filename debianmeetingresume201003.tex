...
\hrule
{\LARGE コラム: 他の OS 上での実行}

Debian ではパッケージが用意されていますが、開発元のサイトでは他の環境向
けのバイナリパッケージが容易されています。
\footnote{\url{http://www.cs.waikato.ac.nz/~ml/weka/index.html}} バイナ
リパッケージが容易されていなくても、weka.jar が格納された ZIP アーカイブ
も用意されているので、Java ランタイムがあるなら下記のように実行すれば Debian 上と同じように使うことができます。
...
\includegraphics[width=1.0\hsize]{image201003/weka8.png}
\end{center}
\end{figure}
...
\begin{center}
\caption{予測結果}
\includegraphics[width=0.8\hsize]{image201003/weka9.png}
\end{center}
\end{figure}
