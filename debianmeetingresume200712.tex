...
3年間実施してきました。Debian勉強会の目標はばりばりとした開発者の育成を
めざすところにあったはずです。すなわち、Debian Developer ではなかった人
が開発をする上での支援ができれば目標にそった活動ができていたということに
なります。では、確認してみましょう。
...
\begin{itemize}
 ...
 \item
      ...
      \footnote{岩松さんがなぜ二つもメールアドレスを使い分けてるのかは不明です。}
 \item
      小林さん
