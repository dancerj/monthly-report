...
\begin{figure}[htbp]
 \begin{center}
  \includegraphics[width=100mm]{image200810/cdn-access.png}
 \end{center}
 \caption{DNSアクセス種別}
...
\begin{figure}[htbp]
 \begin{center}
  \includegraphics[width=100mm]{image200810/cdn-access-rank.png}
 \end{center}
...
\begin{figure}[htbp]
 \begin{center}
  \includegraphics[width=100mm]{image200810/cdn-query-topcountry.png}
 \end{center}
...
\begin{figure}[htbp]
 \begin{center}
  \includegraphics[width=100mm]{image200810/cdn-area-world.png}
 \end{center}
 \caption{地域別振り分け実績}
