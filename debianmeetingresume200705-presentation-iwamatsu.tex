...
\begin{frame}
 \frametitle{The 2th SuperH porting}
  \begin{itemize}
    ...
    \item Renesas can not inability to follow this boom.
  \end{itemize}
\end{frame}
...
\begin{frame}
 \frametitle{Doesn't repeat the history.....}
  ...
  I began porting to SH of Debian in June 2006 .\\
  Because ...
  \begin{itemize}
    \item I 'm Debian user and NM.
 ...
 \begin{itemize}
  ...
  \item Don't build SH3 binary packages
	...
	\begin{itemize}
	  ...
	  \item about cache isse
	\end{itemize}
	
%	A big difference between SH3 and SH4 is whether it is or doesn't exist about FPU.
...
\begin{frame}
 ...
 \frametitle{Links}
   \begin{itemize}
    ...
    \item Debian Packages reppsitory
