...
実装できていない点として、\verb!#<>&!などの文字列をエスケープしないとい
けないのだけど、全然処理できていないです。

transform()関数があるんだけど、一文字を一文字に置換することしかできなく
て、使えないのでいろいろと頑張ることになるらしい。
...
XSLT により提供されている機能が制限されているため、その中で実現できないも
のについては難しい判断を迫られます。

頑張れば制限は回避できるけどどこまで回避するか、悩ましいところです。
