...
\subsubsection{Sphinxとの違い}



breathe\footnote{\url{https://github.com/michaeljones/breathe}}というツールを使
うと、reST/SphinxからDoxygenにデータを渡せるようです。Debianパッケージにはなって
ません。
...
\begin{thebibliography}{0}
 \bibitem{sphinx2010}  Georg Brandl, Shibukawa Yoshiki(Japanese),
	 ``Overview - Sphinx v1.0.6 documentation'' 2007-2010.
	 \url{http://sphinx-users.jp/doc10/}
\end{thebibliography}
