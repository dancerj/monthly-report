...
\begin{frame}{第144回東京エリアDebian勉強会}
...
\section{セミナー1}
\emtext{dh\_strip\_nondeterminism}
...
\url{https://tokyodebianmeeting.titanpad.com/146}
...
\begin{frame}{今後のイベント}
  \begin{itemize}
  \item 12/10(土) Mini Debian Conference Japan 2016
    \begin{itemize}
    \item \url{http://miniconf.debian.or.jp/}
    \item 一般参加者、懇親会、KeySignParty参加者募集
    \end{itemize}    
  \item 12月の東京エリアDebian勉強会はお休みの予定です
  \item 2017/1/21(土) 東京エリアDebian勉強会(予定)
  \end{itemize}
\end{frame}
