...
\begin{figure*}[h!]
    \centering
    \includegraphics[scale=0.4]{image200912/debianosm1.png}
\end{figure*}
...
\begin{figure}[h]
 \centering
 \includegraphics[scale=0.5]{image200912/debianosm2.png}
...
2009年5月に、OSM ユーザ数は 100,000 を越えました。下記に、その登録者数と
作図データの推移グラフを示します。
(出典：\url{http://www.opengeodata.org/2009/03/17/osm-passes-100000-users/})

\begin{figure}[h]
 \centering
 \includegraphics[scale=0.7]{image200912/debianosm3.png}
...
\begin{figure}[h]
 \centering
 \includegraphics[scale=0.8]{image200912/debianosm4.png}
\end{figure}
...
\begin{figure}[h]
 \centering
 \includegraphics[scale=0.5]{image200912/debianosm7.png}
\end{figure}
...
クロスプラットフォームで、JOSM と同じく Debian でも Windows でも動きます。
\end{enumerate}
...
\begin{figure}[h]
 \centering
 \includegraphics[scale=0.7]{image200912/debianosm8.png}
\end{figure}
