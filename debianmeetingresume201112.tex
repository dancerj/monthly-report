...
今回初めて野島が勉強会幹事を勤めましたので、こちらについてサマリしてみます。
...
\hline
開催2週間前までに & Debian JP Blog\footnote{\url{http://www.debian.or.jp/}}及び、
Debian勉強会Webサイト\footnote{\url{http://tokyodebian.alioth.debian.org/}, \url{http://debianmeeting.appspot.com}}に勉強会の内容を提示します。\\
\hline
...
はフォームに沿って情報を入れるだけです。ただ、細かい事は表示能力の為に書きにくい
ので、\url{http://tokyodebian.alioth.debian.org/YYYY-MM.html}へのリンクをURLの
フォームに指定し、細かい事はURLを参照して欲しい旨記載します。
