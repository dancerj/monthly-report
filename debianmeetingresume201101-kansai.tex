...
この原稿を書いている時点で、squeeze のリリース日程として、ついに
具体的に 2 月 5 日前後という話がでてきています。
期待しすぎるのも危険ですが、次回の勉強会では squeeze を安定板と
して語りたいですね。
...
\begin{prework}{ 佐々木洋平 }
  ...
  \item howm: howm-vars.el を byte-compile すると old-style backqoutes
