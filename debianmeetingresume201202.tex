...
\rotatebox{10}{\fontsize{23}{23} {\gt 特集１：Ｄｅｂｉａｎ開発者のＫＤＥ環境あれこれ}}

\rotatebox{10}{\fontsize{23}{23} {\gt 特集２：月刊Ｄｅｂｈｅｌｐｅｒ}}

\rotatebox{10}{\fontsize{23}{23} {\gt 特集３：ｃｍａｋｅつかってみる}}
\vspace*{-2cm}
...
これはすなわち、/usr/share/perl5/Debian/Debhelper/Sequense/ディレクトリにファイルを追加するパッケージをインストールすれば、必ずdh\_追加ほげほげコマンドが実行されることを意味します。
逆に言えば、sbuildやpbuilderのようなクリーンなビルド環境なら、メンテナの意志によりBuild-Dependされたパッケージのdh\_ほげほげコマンドしか実行されませんが、普段使っている環境では、ユーザが既に別途インストールしているdh\_追加ほげほげコマンドも否応なく実行されることを意味します。
