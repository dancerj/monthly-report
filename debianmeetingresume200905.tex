...
% ===============================================================
\dancersection{MC MPI を公式パッケージに}{藤沢}
\index{mcmpidebianofficial}
% ===============================================================

% ===============================================================
\dancersection{Android SDK を使ってみた}{上川純一}
\index{androidsdk}
% ===============================================================
...
Debianパッケージになっているバージョンは古いため、ダウンロードしてきます。
...
emulator を試してみました。
\begin{commandline}
$ tools/android create avd -n uekawadroid -t 2   
Android 1.5 is a basic Android platform.
Do you wish to create a custom hardware profile [no]
Created AVD 'uekawadroid' based on Android 1.5
$ tools/emulator -avd uekawadroid
\end{commandline}
...
\subsection{Androidの簡単なアプリケーションを稼働させてみる}
