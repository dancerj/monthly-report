...
追加します。特に、DEB\_FIXPERMS\_EXCLUDEで、hello.beamを指定して置かない
と、インストール時に実行権限が付与されてしまいます。beamファイルはErlang
...
いのでさらに勉強していきたいです。また、最後に記述したパッケージの作成に
...
dh-erlangのようなツールがあると、DebianでもErlangはさらに便利になってい
くのだろうと思いました。
