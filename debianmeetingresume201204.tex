...
下にインストールされます。npmの場合は /usr/local/lib/nodejs 以下にインストールされます。
...
npm http GET https://registry.npmjs.org/socket.io/-/socket.io-0.9.2.tgz
npm http 200 https://registry.npmjs.org/socket.io/-/socket.io-0.9.2.tgz
npm http GET https://registry.npmjs.org/socket.io-client/0.9.2
  .
  .
  .
socket.io@0.9.2 /node_modules/socket.io 
├── policyfile@0.0.4
├── redis@0.6.7
...
今のところメリットがわからないので手元ではchroot環境でnave / nvm を使わず
に利用しています。

\subsection{Node で CLI}
